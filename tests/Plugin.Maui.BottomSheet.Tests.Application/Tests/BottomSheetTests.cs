...
public class BottomSheetTests : BaseTest<Mocks.EmptyContentPage, BottomSheet>
{
    ...
    public void Constructor_SetsDefaultValues()
    {
        ...
        Assert.Equal(new MauiThickness(5), View.Padding);
    ...
    public void AndroidPlatformConfiguration_SetAndGetProperties_ReturnsExpectedValues()
    {
        ...
        View.SetTheme(99);
        View.On<Android>().SetMargin(new MauiThickness(10,20));
        ...
        Assert.Equal(new MauiThickness(10,20), View.On<Android>().GetMargin());
